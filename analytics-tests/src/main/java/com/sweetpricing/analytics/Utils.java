...
public final class Utils {
  ...
  /** Create a {@link com.sweetpricing.analytics.Traits} with only a randomly generated anonymous ID. */
  public static Traits createTraits() {
    return Traits.create();
  }

  /** Create a {@link com.sweetpricing.analytics.Traits} object with the given {@code userId}. */
  public static Traits createTraits(String userId) {
    return createTraits().putUserId(userId);
  }

  /** Create an {@link com.sweetpricing.analytics.AnalyticsContext} with the given {@code traits}. */
