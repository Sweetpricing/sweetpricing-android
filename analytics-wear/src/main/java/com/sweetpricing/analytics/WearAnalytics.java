...
/**
 * The counterpart to {@link com.sweetpricing.analytics.Analytics} for Android Wear. This class will
...
public class WearAnalytics {
   ...
   * @see com.sweetpricing.analytics.Analytics#track(String, Properties)
   */
   ...
   * @see com.sweetpricing.analytics.Analytics#screen(String, String, Properties)
   */
